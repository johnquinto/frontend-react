...
import { createLinkTask, updateLinkTask } from "../../pages/services/linkService";
import { getTask } from "../../pages/services/taskService";
...
const TaskLinkModal = ({
  ...
  const saveLink = async (key) => {
    if (!key || key == "Enter") {
      ...
      try {
        setLoading(true)
       const res = await createLinkTask({ taskId: taskId, link: linkPasted });
  ...
  const handleDeleteLink = async(linkId) =>{      
      try {
        ...
        await updateLinkTask(taskId, updatedTask);
